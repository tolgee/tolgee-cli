 ...
 */
export function instanceOfPagedModelEntityModelImportFileIssueView(
  value: object
): boolean {
  let isInstance = true;
...
export function PagedModelEntityModelImportFileIssueViewFromJSON(
  json: any
): PagedModelEntityModelImportFileIssueView {
  return PagedModelEntityModelImportFileIssueViewFromJSONTyped(json, false);
}

export function PagedModelEntityModelImportFileIssueViewFromJSONTyped(
  json: any,
...
export function PagedModelEntityModelImportFileIssueViewToJSON(
  value?: PagedModelEntityModelImportFileIssueView | null
): any {
  if (value === undefined) {
    return undefined;
  }
  ...
  return {
    _embedded: PagedModelEntityModelImportFileIssueViewEmbeddedToJSON(
      value.embedded
    ),
