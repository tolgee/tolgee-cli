...
export function ImportLanguageModelFromJSONTyped(
  json: any,
  ...
  return {
    id: json["id"],
    name: json["name"],
    existingLanguageId: !exists(json, "existingLanguageId")
      ? undefined
      : json["existingLanguageId"],
    existingLanguageTag: !exists(json, "existingLanguageTag")
      ? undefined
      : json["existingLanguageTag"],
    existingLanguageAbbreviation: !exists(json, "existingLanguageAbbreviation")
      ? undefined
      : json["existingLanguageAbbreviation"],
    existingLanguageName: !exists(json, "existingLanguageName")
      ? undefined
      : json["existingLanguageName"],
...
export function ImportLanguageModelToJSON(
  value?: ImportLanguageModel | null
): any {
  if (value === undefined) {
    return undefined;
  }
