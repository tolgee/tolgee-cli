...
export function ProjectActivityAuthorModelFromJSON(
  json: any
): ProjectActivityAuthorModel {
  return ProjectActivityAuthorModelFromJSONTyped(json, false);
}

export function ProjectActivityAuthorModelFromJSONTyped(
  json: any,
...
export function ProjectActivityAuthorModelToJSON(
  value?: ProjectActivityAuthorModel | null
): any {
  if (value === undefined) {
    return undefined;
  }
