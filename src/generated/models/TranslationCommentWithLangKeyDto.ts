...
export type TranslationCommentWithLangKeyDtoStateEnum =
  typeof TranslationCommentWithLangKeyDtoStateEnum[keyof typeof TranslationCommentWithLangKeyDtoStateEnum];

/**
 * Check if a given object implements the TranslationCommentWithLangKeyDto interface.
 */
export function instanceOfTranslationCommentWithLangKeyDto(
  value: object
): boolean {
  let isInstance = true;
...
export function TranslationCommentWithLangKeyDtoFromJSON(
  json: any
): TranslationCommentWithLangKeyDto {
  return TranslationCommentWithLangKeyDtoFromJSONTyped(json, false);
}

export function TranslationCommentWithLangKeyDtoFromJSONTyped(
  json: any,
...
export function TranslationCommentWithLangKeyDtoToJSON(
  value?: TranslationCommentWithLangKeyDto | null
): any {
  if (value === undefined) {
    return undefined;
  }
