...
export function TranslationMemoryItemModelFromJSON(
  json: any
): TranslationMemoryItemModel {
  return TranslationMemoryItemModelFromJSONTyped(json, false);
}

export function TranslationMemoryItemModelFromJSONTyped(
  json: any,
...
export function TranslationMemoryItemModelToJSON(
  value?: TranslationMemoryItemModel | null
): any {
  if (value === undefined) {
    return undefined;
  }
