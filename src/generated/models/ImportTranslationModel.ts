...
export function ImportTranslationModelFromJSON(
  json: any
): ImportTranslationModel {
  return ImportTranslationModelFromJSONTyped(json, false);
}

export function ImportTranslationModelFromJSONTyped(
  json: any,
  ...
  return {
    ...
    conflictText: !exists(json, "conflictText")
      ? undefined
      : json["conflictText"],
...
export function ImportTranslationModelToJSON(
  value?: ImportTranslationModel | null
): any {
  if (value === undefined) {
    return undefined;
  }
