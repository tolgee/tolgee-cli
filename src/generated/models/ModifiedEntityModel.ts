...
export function ModifiedEntityModelFromJSONTyped(
  json: any,
  ...
  return {
    ...
    relations: !exists(json, "relations")
      ? undefined
      : mapValues(json["relations"], ExistenceEntityDescriptionFromJSON),
    _exists: !exists(json, "exists") ? undefined : json["exists"],
  };
}

export function ModifiedEntityModelToJSON(
  value?: ModifiedEntityModel | null
): any {
  if (value === undefined) {
    return undefined;
  }
  ...
  return {
    ...
    relations:
      value.relations === undefined
        ? undefined
        : mapValues(value.relations, ExistenceEntityDescriptionToJSON),
