...
export function SetTranslationsWithKeyDtoFromJSON(
  json: any
): SetTranslationsWithKeyDto {
  return SetTranslationsWithKeyDtoFromJSONTyped(json, false);
}

export function SetTranslationsWithKeyDtoFromJSONTyped(
  json: any,
  ...
  return {
    ...
    languagesToReturn: !exists(json, "languagesToReturn")
      ? undefined
      : json["languagesToReturn"],
  };
}

export function SetTranslationsWithKeyDtoToJSON(
  value?: SetTranslationsWithKeyDto | null
): any {
  if (value === undefined) {
    return undefined;
  }
  ...
  return {
    ...
    languagesToReturn:
      value.languagesToReturn === undefined
        ? undefined
        : Array.from(value.languagesToReturn as Set<any>),
  };
}
