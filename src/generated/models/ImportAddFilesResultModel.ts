...
export function ImportAddFilesResultModelFromJSON(
  json: any
): ImportAddFilesResultModel {
  return ImportAddFilesResultModelFromJSONTyped(json, false);
}

export function ImportAddFilesResultModelFromJSONTyped(
  json: any,
  ...
  return {
    ...
    result: !exists(json, "result")
      ? undefined
      : PagedModelImportLanguageModelFromJSON(json["result"]),
  };
}

export function ImportAddFilesResultModelToJSON(
  value?: ImportAddFilesResultModel | null
): any {
  if (value === undefined) {
    return undefined;
  }
