...
export function LanguageStatsModelFromJSONTyped(json: any, ignoreDiscriminator: boolean): LanguageStatsModel {
    ...
    return {
        ...
        'languageOriginalName': !exists(json, 'languageOriginalName') ? undefined : json['languageOriginalName'],
        'languageFlagEmoji': !exists(json, 'languageFlagEmoji') ? undefined : json['languageFlagEmoji'],
...
export function LanguageStatsModelToJSON(value?: LanguageStatsModel | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
