 ...
 */
export function instanceOfPagedModelImportLanguageModelEmbedded(
  value: object
): boolean {
  let isInstance = true;
...
export function PagedModelImportLanguageModelEmbeddedFromJSON(
  json: any
): PagedModelImportLanguageModelEmbedded {
  return PagedModelImportLanguageModelEmbeddedFromJSONTyped(json, false);
}

export function PagedModelImportLanguageModelEmbeddedFromJSONTyped(
  json: any,
  ...
  return {
    languages: !exists(json, "languages")
      ? undefined
      : (json["languages"] as Array<any>).map(ImportLanguageModelFromJSON),
  };
}

export function PagedModelImportLanguageModelEmbeddedToJSON(
  value?: PagedModelImportLanguageModelEmbedded | null
): any {
  if (value === undefined) {
    return undefined;
  }
  ...
  return {
    languages:
      value.languages === undefined
        ? undefined
        : (value.languages as Array<any>).map(ImportLanguageModelToJSON),
  };
}
