...
export function ComplexEditKeyDtoFromJSONTyped(
  json: any,
  ...
  return {
    ...
    screenshotIdsToDelete: !exists(json, "screenshotIdsToDelete")
      ? undefined
      : json["screenshotIdsToDelete"],
    screenshotUploadedImageIds: !exists(json, "screenshotUploadedImageIds")
      ? undefined
      : json["screenshotUploadedImageIds"],
  };
}
