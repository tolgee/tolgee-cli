...
export type TranslationHistoryModelRevisionTypeEnum =
  typeof TranslationHistoryModelRevisionTypeEnum[keyof typeof TranslationHistoryModelRevisionTypeEnum];
...
export function TranslationHistoryModelFromJSON(
  json: any
): TranslationHistoryModel {
  return TranslationHistoryModelFromJSONTyped(json, false);
}

export function TranslationHistoryModelFromJSONTyped(
  json: any,
  ...
  return {
    modifications: !exists(json, "modifications")
      ? undefined
      : mapValues(json["modifications"], PropertyModificationFromJSON),
    timestamp: json["timestamp"],
    author: !exists(json, "author")
      ? undefined
      : SimpleUserAccountModelFromJSON(json["author"]),
    revisionType: json["revisionType"],
  };
}

export function TranslationHistoryModelToJSON(
  value?: TranslationHistoryModel | null
): any {
  if (value === undefined) {
    return undefined;
  }
  ...
  return {
    modifications:
      value.modifications === undefined
        ? undefined
        : mapValues(value.modifications, PropertyModificationToJSON),
