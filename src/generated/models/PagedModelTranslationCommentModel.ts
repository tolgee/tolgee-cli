...
import type { PagedModelTranslationCommentModelEmbedded } from "./PagedModelTranslationCommentModelEmbedded";
import {
...
/**
 * Check if a given object implements the PagedModelTranslationCommentModel interface.
 */
export function instanceOfPagedModelTranslationCommentModel(
  value: object
): boolean {
  let isInstance = true;
...
export function PagedModelTranslationCommentModelFromJSON(
  json: any
): PagedModelTranslationCommentModel {
  return PagedModelTranslationCommentModelFromJSONTyped(json, false);
}

export function PagedModelTranslationCommentModelFromJSONTyped(
  json: any,
  ...
  return {
    embedded: !exists(json, "_embedded")
      ? undefined
      : PagedModelTranslationCommentModelEmbeddedFromJSON(json["_embedded"]),
...
export function PagedModelTranslationCommentModelToJSON(
  value?: PagedModelTranslationCommentModel | null
): any {
  if (value === undefined) {
    return undefined;
  }
