...
export type ExportParamsFormatEnum =
  typeof ExportParamsFormatEnum[keyof typeof ExportParamsFormatEnum];
...
export type ExportParamsFilterStateEnum =
  typeof ExportParamsFilterStateEnum[keyof typeof ExportParamsFilterStateEnum];
...
export function ExportParamsFromJSONTyped(
  json: any,
  ...
  return {
    ...
    filterKeyIdNot: !exists(json, "filterKeyIdNot")
      ? undefined
      : json["filterKeyIdNot"],
    filterTag: !exists(json, "filterTag") ? undefined : json["filterTag"],
    filterKeyPrefix: !exists(json, "filterKeyPrefix")
      ? undefined
      : json["filterKeyPrefix"],
  ...
  return {
    languages:
      value.languages === undefined
        ? undefined
        : Array.from(value.languages as Set<any>),
    format: value.format,
