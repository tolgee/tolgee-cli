...
export type TranslationCommentModelStateEnum =
  typeof TranslationCommentModelStateEnum[keyof typeof TranslationCommentModelStateEnum];
...
export function TranslationCommentModelFromJSON(
  json: any
): TranslationCommentModel {
  return TranslationCommentModelFromJSONTyped(json, false);
}

export function TranslationCommentModelFromJSONTyped(
  json: any,
...
export function TranslationCommentModelToJSON(
  value?: TranslationCommentModel | null
): any {
  if (value === undefined) {
    return undefined;
  }
