...
import type { ExportParams } from "../models";
import { ExportParamsFromJSON, ExportParamsToJSON } from "../models";
...
export class ExportApi extends runtime.BaseAPI {
   ...
   */
  async export1Raw(
    requestParameters: Export1Request,
    ...
    if (requestParameters.splitByScopeDelimiter !== undefined) {
      queryParameters["splitByScopeDelimiter"] =
        requestParameters.splitByScopeDelimiter;
    }

    if (requestParameters.splitByScopeDepth !== undefined) {
      queryParameters["splitByScopeDepth"] =
        requestParameters.splitByScopeDepth;
    }
   ...
   */
  async exportPost1Raw(
    requestParameters: ExportPost1Request,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<object>> {
    if (
      requestParameters.exportParams === null ||
      requestParameters.exportParams === undefined
    ) {
      throw new runtime.RequiredError(
        "exportParams",
        "Required parameter requestParameters.exportParams was null or undefined when calling exportPost1."
      );
    }
  ...
  async exportPost1(
    ...
    const response = await this.exportPost1Raw(
      requestParameters,
      initOverrides
    );
    return await response.value();
...
export type Export1FormatEnum =
  typeof Export1FormatEnum[keyof typeof Export1FormatEnum];
/**
 * @export
 */
...
export type Export1FilterStateEnum =
  typeof Export1FilterStateEnum[keyof typeof Export1FilterStateEnum];
