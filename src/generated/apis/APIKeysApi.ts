...
import type { ApiKeyWithLanguagesModel } from "../models";
import {
...
export class APIKeysApi extends runtime.BaseAPI {
   ...
   */
  async getCurrentRaw(
    requestParameters: GetCurrentRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<ApiKeyWithLanguagesModel>> {
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      ApiKeyWithLanguagesModelFromJSON(jsonValue)
    );
  }
  ...
  async getCurrent(
    requestParameters: GetCurrentRequest = {},
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<ApiKeyWithLanguagesModel> {
