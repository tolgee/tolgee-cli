export const Grammars = {
  TypeScript: 'https://raw.githubusercontent.com/microsoft/TypeScript-TmLanguage/master/TypeScript.tmLanguage',
  TypeScriptReact: 'https://raw.githubusercontent.com/microsoft/TypeScript-TmLanguage/master/TypeScriptReact.tmLanguage',
}

export const Licenses = [
  {
    grammars: [ 'TypeScript', 'TypeScriptReact' ],
    license: 'https://raw.githubusercontent.com/microsoft/TypeScript-TmLanguage/master/LICENSE.txt'
  }
]
...
export const Transformers = {
  TypeScriptReact: (self, grammars) => {
    ...
    const transformed = self.replace(
      /[a-z.-]+\.tsx/g,
      (tokenType) => {
        const tokenTypeTs = tokenType.slice(0, -1)
        return tokenType !== 'source.tsx' && grammars.TypeScript.includes(tokenTypeTs)
          ? tokenTypeTs
          : tokenType
      }
    )
